    ...
    <div className="bg-gray-50">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-gray-800 text-center">Make Your One-Time Gift</h2>
            <p className="text-center mt-2 text-gray-600">A single act of kindness can change a life. Choose a tier or give from the heart.</p>
            <div className="mt-10">
                <DonateTiers />
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Impact Story */}
            <div className="order-1 lg:order-2 bg-gray-50 p-8 rounded-2xl border border-gray-200">
