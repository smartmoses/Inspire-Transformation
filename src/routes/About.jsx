...
const journeyTimeline = [
    { year: '2021', title: 'The Vision is Born', description: 'Our founder, Deborah Okoi, establishes the core mission after identifying a critical need for mentorship in the community.' },
    { year: '2022', title: 'First Workshop Launch', description: 'We held our first Community Resilience workshop, serving 25 individuals and marking our official start.' },
    { year: '2023', title: 'Partnership with Local Churches', description: 'Forged key partnerships with 5 local faith communities, expanding our reach and volunteer base.' },
    { year: '2024', title: 'Exceeding 100 Lives Touched', description: 'A major milestone reached through the expansion of our mentorship and outreach programs.' },
];
...
export default function AboutPage() {
  return (
    <div className="bg-white">
      {/* 1. Page Header/Hero */}
      <section className="relative bg-stone-800 text-white py-24 sm:py-32">
         <div 
            ...
            >
                <div className="space-y-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-stone-800">Our Mission</h3>
                     ...
                     <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-stone-800">Our Vision</h3>
                            <p className="mt-2 text-stone-600 leading-relaxed">
      ...
      <section className="bg-stone-50 py-20">
        <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-stone-800 tracking-tight">Our Journey of Impact</h2>
                <p className="mt-3 text-lg text-stone-600">From a simple vision to a growing movement, here are the key milestones that have shaped our story.</p>
            </div>
            <div className="relative">
                {/* The vertical line */}
                <div className="absolute left-4 top-0 h-full w-0.5 bg-stone-300" aria-hidden="true"></div>
                {/* Timeline items */}
                <div className="space-y-12">
                    {journeyTimeline.map((item, index) => (
                        ...
                        >
                            ...
                            <h3 className="mt-1 text-xl font-bold text-stone-800">{item.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
                <h2 className="text-3xl sm:text-4xl font-bold text-stone-800 tracking-tight">Meet Our Leaders</h2>
      ...
      <section className="bg-stone-800">
         <div className="max-w-4xl mx-auto px-6 py-20 text-center">
             ...
             <p className="mt-4 max-w-xl mx-auto text-lg text-stone-300">
